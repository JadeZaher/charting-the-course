// Edge Function: journey-maps/update
// POST — Replace full content_sequence + metadata. Requires canManageContent.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (error) {
      ...
      return errorResponse("Failed to update journey map", error.message, 500);
    }
